...
with open('./sudoku_up_out.txt', 'r') as r:
    one_line = r.read()
...
with open("./cs_one_line.txt", "w") as w:
    w.write(one_line)
...
with open('./cs_one_line.txt', 'r') as input_text, open('sudoku_up_export.csv', 'w') as export_csv:
    ...
    for line in lines:
        ...
        sudoku, number, autor, hodoku_level, hodoku_value = sudoku_info 
        ...
        export_csv.write(f'{sudoku}|{number}|{autor}|{hodoku_level}|{hodoku_value}|{techniques}\n')
